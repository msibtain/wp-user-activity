...
if (empty($user_roles)) {
    echo '<div class="wpual-team-hub-notice"><p>No role assigned. Cannot display team activities.</p></div>';
    return;
}
...
if (empty($team_users)) {
    echo '<div class="wpual-team-hub-notice"><p>No team members found with the same role.</p></div>';
    return;
}
